...
var wordsList = [
    "As the first rays of the morning sun peeked over the horizon, the sleepy town awoke to the gentle chirping of birds and the promise of a new day.",
    "With a mischievous grin, he carefully placed the surprise gift behind her back, eagerly waiting for her delighted reaction when she turned around.",
    "The majestic oak tree, standing tall in the middle of the meadow, provided a welcome shade for the weary travelers on a hot summer's day.",
    "The chocolate chip cookies smelled so good that I ate one without asking.",
    "The butterfly landed gently on her outstretched hand.",
